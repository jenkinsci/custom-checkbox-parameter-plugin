...
public class CheckboxParameterDefinitionTests {
	...
	public void testScriptedPipeline() throws Exception{
		...
		CheckboxParameterDefinition param = new CheckboxParameterDefinition(Name,description,protocol,format,submitContent,uri,displayNodePath,valueNodePath,tlsVersion,useInput);
